...
extern void *dbg_malloc(unsigned long size);
extern void *dbg_memalign(unsigned long alignment, unsigned long size);

extern void *dbg_realloc(void *ptr, unsigned long size);
extern void *dbg_calloc(unsigned long num, unsigned long size);
...
#define memalign(a, s) (FILE_LINE, dbg_memalign(a, s))
...
#else
#define dbg_init(n)
#define dbg_check_addr(m, p, o)
#define dbg_mem_stat()
#define dbg_zero_stat()
#define dbg_abort(m)
#define dbg_heap_dump(k)
#define dbg_history_dump(k)
#define dbg_catch_sigsegv()
#endif
...
extern char *dbg_strndup(const char *s, unsigned long n);
