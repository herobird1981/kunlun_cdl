...
/*                                                                                                                                                                                           */
/*-----------------------------------------------------------------------------------------------------------*/
#ifndef __CDL_DAC_H__
#define __CDL_DAC_H__
#include "cdl_types.h"

/* DAC DIGITAL VOLUME CONTROL 1 */
...
/* ATC: Attenuator Control Mode */
#define WM8766_DAC_ATC			(1 << 3)    /* 0: Right ch use right attenuations,
											   1: Right ch use left attenuations */
#define WM8766_DAC_IZD			(1 << 4)    /* IZD: Infinite zero detect enable */
...
/* Master or salve select */
#define WM8766_DAC3_MASTER		(1 << 5)
/* Master mode LRCLK Ratio select */
...
#define WM8766_DAC3_MSTR_LRCLK_MASK		0x1c0
...
extern struct snd_wm8766 g_wm[2];
